 ...
 * (`ws://127.0.0.1:3000`). Mirrors `normalizeRelayUrl` in
 * `apps/desktop-host/src/managed-agents.ts`: lowercase host, loopback hosts
 * folded to 127.0.0.1, default ports and root-path trailing slash stripped.
